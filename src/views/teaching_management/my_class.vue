	...
	<section class="cm-container">
        ...
        <div class="cm-table">
            <el-table
                ...
                <el-table-column label="当前审批人" prop="nextApprover" width="90"></el-table-column>
                <el-table-column
                    ...
                    <template slot-scope="scope">
						...
						<el-button 
						@click="openDialogs(1,scope.row.id)" 
						type="text" size="small" v-if="btnPerObj.detail">查看详情</el-button>
                        <template v-if="scope.row.status == 0 ">
							...
							<el-button v-else 
							@click="openDialogs(0,scope.row.id)" 
							type="text" size="small">处理</el-button>
                        </template>
                        <!-- <template v-else-if="scope.row.status == 3">
                        	<el-button type="text" size="small" @click="reApplyClass(scope.row)">再次申请</el-button>
                        </template> -->
                    </template>
                </el-table-column>
...
//				scheduleList:[],//排课课程
				...
				pagePort:{
		        	...
		        	myExchangeList: '_ed:exchangecourse/query/mylist', // 调课表格数据(分页)
