    ...
    <section class="cm-container">
        ...
        <div class="cm-table">
            <el-table
        		size="mini"
                ref="multipleTable"
                :data="tableData.slice((currentPage1-1)*sizeperpage,currentPage1*sizeperpage)"
                border
                ...
                <el-table-column prop="stageName"  width="100" label="阶段" >
                     <template slot-scope="scope">
                        {{  filterFun(scope.row.stageName) }}
                    </template>
                </el-table-column>
                <el-table-column prop="courseGrade" width="80" label="课程成绩">
                    <template slot-scope="scope">
                    {{  filterFun(scope.row.courseGrade) }}
                    </template>
                </el-table-column>
                <el-table-column prop="stageGrade"   width="100" label="阶段成绩">
                     <template slot-scope="scope">
                        {{  filterFun(scope.row.stageGrade) }}
                    </template>

                </el-table-column>
                 <el-table-column prop="stageGradeDetail" min-width="500"  label="阶段成绩明细" style="text-align:left;">
                    <template  slot-scope="scope">
