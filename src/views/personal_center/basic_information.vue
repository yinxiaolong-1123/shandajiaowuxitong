<template>
	<div>
		...
		<div class="basic_container">
            ...
            <div class="box">
                ...
                <div class="content">
                    <div class="left">
                        <p class="linecell">
                            <label>学 号</label>
                            <input v-model="stuNum"
                                :disabled="true"
                                class="input-reg">
                        </p>
                        <p class="linecell">
                            <label>考生号</label>
                            <input v-model="testNum"
                                :disabled="true"
                                class="input-reg">
                        </p>
                        <p class="linecell">
                        ...
                        <p class="linecell">
                            <label>拼音</label>
                            <el-input :disabled="true" v-model="spellName"></el-input>
                        </p>
                        <p class="linecell">
                            <label>曾用名</label>
                            <el-input :disabled="true" v-model="formerName"></el-input>
                        </p>
                        <p class="linecell">
                            <label>性别</label>
                            <el-select :disabled="true" v-model="sex" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>国籍</label>
                            <el-select :disabled="true" v-model="countryId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>民族</label>
                            <el-select :disabled="true" v-model="nationId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>出生日期</label>
                            <el-date-picker :disabled="true" v-model="birthday" type="date" value-format="yyyy-MM-dd" placeholder=" ">
                            </el-date-picker>
                        </p>
                        <p class="linecell">
                            <label>出生地</label>
                            <el-cascader :disabled="true" placeholder=" " :options="cityList" v-model="birthProvinceCityId"
                                :props="{ expandTrigger: 'hover',checkStrictly: true }">
                            </el-cascader>
                        </p>
                        <p class="linecell">
                            <label>籍贯</label>
                            <el-cascader placeholder=" " :disabled="true" :options="cityList" v-model="nativeProvinceCityId"
                                :props="{ expandTrigger: 'hover',checkStrictly: true }">
                            </el-cascader>
                        </p>
                        <p class="linecell">
                            <label>生源地</label>
                            <el-cascader placeholder=" " :disabled="true" :options="cityList" v-model="sourceProvinceCityId"
                                :props="{ expandTrigger: 'hover',checkStrictly: true }">
                            </el-cascader>
                        </p>
                        <p class="linecell">
                            <label>政治面貌</label>
                            <el-select :disabled="true" v-model="politicsStatusId" placeholder=" "
                            >
                        ...
                        <p class="linecell">
                            <label>健康状况</label>
                            <el-select :disabled="true" v-model="healthStatusId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>证件号</label>
                            <el-input :disabled="true" v-model="cardNum"
                                placeholder="证件号限制18位"></el-input>
                        </p>
                        <p class="linecell">
                            <label>户口性质</label>
                            <el-select :disabled="true" v-model="registerTypeId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>应往届</label>
                            <el-select :disabled="true" v-model="stuModelId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>微信</label>
                            <el-input :disabled="true" v-model="wechat"></el-input>
                        </p>
                        <p class="linecell">
                            <label>QQ</label>
                            <input v-model="qq"
                    ...
                    <div class="right">
                        <div class="imgbox">
                            <el-upload :disabled="true" class="avatar-uploader" action="operation/data/admin/uploadFile"
                        ...
                        <p class="linecell">
                            <label>入学方式</label>
                            <el-select :disabled="true" v-model="entrance" placeholder=" ">
                                <el-option label="统考" value="1"> </el-option>
                            </el-select>
                        </p>
                        <p class="linecell">
                            <label>证件类型</label>
                            <el-select :disabled="true" v-model="cardTypeId" placeholder=" "
                            >
                        ...
                        <p class="linecell">
                            <label>户口所在地</label>
                            <el-cascader placeholder=" " :disabled="true" :options="cityList" v-model="registerProvinceCityId"
                                :props="{ expandTrigger: 'hover',checkStrictly: true }">
                            </el-cascader>
                        </p>
                        <p class="linecell">
                            <label>手机号码</label>
                            <el-input :disabled="true" v-model="mobile">
                            </el-input>
                        </p>
                        <p class="linecell">
                            <label>学生特征</label>
                            <el-select :disabled="true" v-model="stuFeatureId" placeholder=" ">
                ...
                <p class="bottom">
                    <label>备注</label>
                    <el-input :disabled="true" v-model="remark"></el-input>
                </p>
            </div>
            <!-----------------家庭信息------------------------>
            <div class="box">
                ...
                <div class="contentline">
                    <p class="linecell">
                        ...
                        <el-input :disabled="true" v-model="contactPerson"></el-input>
                    </p>
                    <!-- <p class="linecell">
                        <label>证件类型</label>
                        <el-select v-model="onecardTypeId" placeholder=" ">
                            <el-option 
                    ...
                    <p class="linecell">
                        <!-- <label>证件类型</label> -->
                        <label>证件类型</label>
                        <el-select :disabled="true" v-model="oneCardTypeId" placeholder=" ">
                    ...
                    <p class="linecell">
                        <!-- <label>证件号码</label> -->
                        <label>证件号码</label>
                        <el-input :disabled="true" v-model="oneCardNum"></el-input>
                    </p>
                    <p class="linecell">
                        <label>联系电话</label>
                        <el-input :disabled="true" v-model="contactTel"></el-input>
                    </p>
                    <p class="linecell">
                        <label>邮政编码</label>
                        <el-input :disabled="true" v-model="postalCode"></el-input>
                    </p>
                    <p class="linecell">
                        <label>家庭住址</label>
                    ...
                    <p class="linecell">
                        <label>父母或监护人2</label>
                        <el-input :disabled="true" v-model="twoContactPerson"></el-input>
                    </p>
                    <!-- <p class="linecell">
                        <label>证件类型</label>
                        <el-select v-model="twoCardTypeId" placeholder=" ">
                            <el-option 
                                v-for="item in idCategoryList" 
                                :key="item.id" 
                                :label="item.name" 
                    ...
                    <p class="linecell">
                        <label>证件类型</label>
                        <el-select :disabled="true" v-model="twoCardTypeId" placeholder=" ">
                            <el-option v-for="item in idCategoryList" :key="item.id" :label="item.name" :value="item.id">
                            </el-option>
                        </el-select>
                    </p>
                    <p class="linecell">
                        <label>证件号码</label>
                        <el-input :disabled="true" v-model="twoCardNum"></el-input>
                    </p>
                    <p class="linecell">
                        <label>联系电话</label>
                        <el-input :disabled="true" v-model="twoContactTel"></el-input>
                    </p>
                    <p class="linecell">
                        <label>邮政编码</label>
                        <el-input :disabled="true" v-model="twoPostalCode"></el-input>
                    </p>
                    <p class="linecell">
                        <label>家庭住址</label>
                        <el-input :disabled="true" v-model="twoAddress"></el-input>
                    </p>
                </div>
                <!-- <p class="bottom">
                    <label>家庭住址</label>
            ...
            <!-----------------学籍信息------------------------>
            <div class="box">
                <p class="title">学籍信息</p>
                <div class="content">
                    <div class="left">
                        <p class="linecell">
                            <label>入学日期</label>
                            <el-date-picker :disabled="true" v-model="enrollmentDate" type="date" value-format="yyyy-MM-dd" placeholder=" "
                                > </el-date-picker>
                        </p>
                        <p class="linecell">
                            <label>所在级</label>
                            <intelligent-year-picker :disabled="true" v-model="enrollmentYear" type="year" value-format="yyyy" placeholder=" "
                                > </intelligent-year-picker>
                        </p>
                        <p class="linecell">
                            <label>学制</label>
                            <el-select :disabled="true" v-model="eduNumId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>修业年限</label>
                            <el-select :disabled="true" v-model="studyNumId" placeholder=" " @change="yearListFind">
                        ...
                        <p class="linecell">
                            <label>学习形式</label>
                            <el-select :disabled="true" v-model="studyModelId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>层次</label>
                            <el-select :disabled="true" v-model="stageId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>办学类型</label>
                            <el-select :disabled="true" v-model="eduTypeId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>预计毕业日期</label>
                            <el-date-picker :disabled="true" v-model="expectDate" type="date" value-format="yyyy-MM-dd" placeholder=" ">
                            </el-date-picker>
                        </p>
                        <p class="linecell">
                            <label>学籍状态</label>
                            <el-select :disabled="true" v-model="status" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>毕业/结业</label>
                            <el-select :disabled="true" v-model="graduationStatus" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>毕业日期</label>
                            <el-date-picker :disabled="true" v-model="graduationDate" type="date" value-format="yyyy-MM-dd"
                                placeholder=" "> </el-date-picker>
                        </p>
                        <p class="linecell">
                            <label>毕业证书编号</label>
                            <el-input :disabled="true" v-model="graduationNum"></el-input>
                        </p>
                        <p class="linecell">
                            <label>获学位日期</label>
                            <el-date-picker :disabled="true" v-model="diplomaDate" type="date" value-format="yyyy-MM-dd" placeholder=" ">
                            </el-date-picker>
                        </p>
                        <p class="linecell">
                            <label>学位证书编号</label>
                            <el-input :disabled="true" v-model="diplomaNum"></el-input>
                        </p>
                    </div>
                    ...
                    <div class="right">
                        <p class="linecell">
                            <label>所在专业</label>
                            <el-select :disabled="true" v-model="majorId" placeholder=" ">
                        ...
                        <p class="linecell">
                            <label>所在行政班</label>
                            <el-select :disabled="true"  v-model="administrativeClassId"
                                placeholder=" ">
                        ...
                        <p>
                            <el-checkbox :disabled="true" v-for="(item,index) in eduCheckList" :key="index" v-model="item.checked"
                                >{{item.prop}}</el-checkbox>
                        </p>
                        <p class="linecell">
                            <label>决议编号</label>
                            <el-input :disabled="true" v-model="decisionNum"></el-input>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="box">
                ...
                <div class="contentline">
                    <p class="linecell">
                        <label>上一层次</label>
                        <el-select :disabled="true" v-model="provStageId" placeholder=" ">
                    ...
                    <p class="linecell">
                        <label>招生季节</label>
                        <el-select :disabled="true" v-model="seasonId" placeholder=" ">
                    ...
                    <p class="linecell">
                        <label>毕业学校</label>
                        <el-input :disabled="true" v-model="graduationSchool"></el-input>
                    </p>
                    <p class="linecell">
                        <label>毕业类型</label>
                        <el-select :disabled="true" v-model="graduationType" placeholder=" ">
                    ...
                    <p class="linecell">
                        <label>高考成绩</label>
                        <input :disabled="true" v-model="score"
                            class="input-reg">
                    </p>
                </div>
            </div>
		...
		methods: {
            getStuInfo(){
                ...
                this.$http.post("_op:/students/list", {
                    ...
                    if(res.code == 0){
                        this.stuInfo = res.data.records[0]
			...
			initParameters(row) {
				...
				console.log(row)
				console.log(row.nativeProvinceCityIds)
				//籍贯*
				...
				this.twoCardNum = row.twoCardNum;
				...
				this.status = row.status.toString() == 1 ? '1' : '2'; //学籍状态
...
<style scoped lang="less">
    ...
    .box /deep/ .el-input.is-disabled .el-input__inner{
